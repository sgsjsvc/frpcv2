...
func runClient(cfgFilePath string, unsafeFeatures *security.UnsafeFeatures) error {
	...
	if err == nil && result.IsLegacyFormat {
	...
	bundle, err := runtime.PrepareClientService(cfgFilePath, strictConfigMode, allowUnsafe)
	if err != nil {
		return err
	}
	return runtime.RunPreparedService(bundle)
}
